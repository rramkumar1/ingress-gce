...
func NewController(
	...
	mciController := &Controller{
		...
		clusterSynced: ctx.ClusterInformer.HasSynced,
		clusterLister: ctx.ClusterInformer.GetIndexer(),
	}

	ctx.ClusterInformer.AddEventHandler(cache.ResourceEventHandlerFuncs{
